...
echo "<BR><h2 class=head1 align='center'><span class=\"label label-info\">Subject Add </span></h2>";
...
<title>Add Subject</title></br></br></br></br></br></br></br></br></br>
  ...
  <table width="41%"  border="0" align="center">
    <tr>
      ...
      <td width="53%" height="32">
        <input name="subname" placeholder="Subject Name" type="text" id="subname" class="form-control">
    <tr>
        <td height="26"> </td>
        <td>&nbsp;</td>
	  <td>&nbsp;</td>
